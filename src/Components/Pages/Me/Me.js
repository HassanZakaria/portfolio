      ...
      <Card className={classes.root}>
        <CardContent>
          <Typography variant="body1" component="p">
            Hi, my name is Hassan. I'm an Engineering graduate who's extremely
            interested in web development and passionate about the need of
            improving the user interface using the latest frameworks
            technologies. I'm highly ambitious and eager to learn. Currently
